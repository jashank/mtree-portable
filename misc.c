...
/*	from CSRG:   @(#)misc.c	8.1 (Berkeley) 6/6/93 */
/*	from NetBSD: misc.c,v 1.34 2012/12/20 19:09:25 christos Exp */
/*	from pkgsrc: misc.c,v 1.3 2008/11/06 02:14:52 jschauma Exp */
